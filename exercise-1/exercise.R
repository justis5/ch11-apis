...
info_data <- fromJSON(body)

# How many (public) repositories does the organization have?
num_public <- nrow(info_data)
print(num_public)
##### New query ######
